...
# normalise coverage before we split A and B genome
allc$covNormByMean <- allc$cov/mean(all$cov)  
mean(allc$covNormByMean)
[1] 1
...
pdf(file = "ABchr_plantain_covPerSam_mean_all_byA.pdf",width =8, height = 12)
pgs
dev.off()
...
pdf(file = "ABchr_plantain_covPerSam_mean_all_byB.pdf",width =8, height = 12)
pgs
dev.off()
